            ...
            {group === "categories" && (
                ...
                >
                    ...
                    <div className="relative">
                        ...
                        {/* استفاده از selector درست */}
                        <ScrollIndicator selector="#categories-scroll-container" ScrollToTop={false} PositionClasses={"absolute bottom-1 left-1/2"} heightwidth={6} />
                    </div>
                </div>
            )}
        </div>
